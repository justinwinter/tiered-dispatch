...
| **Teams** | Org-wide routing policy enforcement, per-account savings metering, verifiable escalation ledger, SSO/directory sync. Ships **at launch**. | Self-serve / listed pricing |
...
- No invented pricing numbers before launch.
